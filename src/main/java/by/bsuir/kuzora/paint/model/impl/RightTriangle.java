...
/**
 * RightTriangle class extends {@link Triangle}.
 * <p>
 * Class {@link RightTriangle} includes overriding for 2 abstract methods getType(), draw() which come from {@link by.bsuir.kuzora.paint.model.interfaces.Figure} class.
 * <p>
...
public class RightTriangle extends Triangle {
     ...
     */
    public RightTriangle(double x1, double y1, double x2, double y2) {
        super(x1, y1, x2, y2);
    }
    ...
    public FigureType getType() {
        return FigureType.RIGHT_TRIANGLE;
    }
}
