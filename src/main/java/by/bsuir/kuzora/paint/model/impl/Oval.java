...
/**
 * Oval class extends {@link Figure} and if possible implements {@link Editable}.
 * <p>
 * Class {@link Oval} includes implementations for 2 abstract methods getType(), draw() which come from {@link Figure} class.
 * <p>
 * <i>This class is a member of the {@link by.bsuir.kuzora.paint.model.impl} package.</i>
 */
public class Oval extends Figure implements Editable {
